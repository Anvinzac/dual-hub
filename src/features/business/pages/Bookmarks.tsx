...
import { thumbnails } from "@/features/business/data/thumbnails";
import { useApps } from "@/features/business/hooks/useApps";
import { useLikedApps } from "@/features/business/hooks/useLikedApps";
import { BUSINESS_AI_GUIDE_PATH, BUSINESS_BASE_PATH } from "@/features/business/routes";
...
const Bookmarks = () => {
  ...
  const handleCopyAll = () => {
    ...
    setTimeout(() => navigate(BUSINESS_AI_GUIDE_PATH), 500);
  };
      ...
      {bookmarkedApps.length === 0 ? (
        <div className="flex flex-col items-center justify-center px-6 pt-32 text-center">
          ...
          <button
            ...
            onClick={() => navigate(BUSINESS_BASE_PATH)}
          >
            Browse Gallery
          </button>
        </div>
