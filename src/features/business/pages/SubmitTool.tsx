...
import { submitToolSchema, SubmitToolFormData } from "@/features/business/lib/schemas";
import { submitApp } from "@/features/business/lib/apps";
import { BUSINESS_BASE_PATH } from "@/features/business/routes";
    ...
    return (
      <div className="business-shell bg-themed-gradient min-h-screen pb-20 text-foreground">
        <div className="px-4 py-3 border-b border-border/50">
          <button className="flex items-center gap-2 text-sm font-semibold font-display active:opacity-70" onClick={() => navigate(BUSINESS_BASE_PATH)}>
        ...
        <div className="flex flex-col items-center justify-center px-6 pt-24 text-center">
          ...
          <button className="bg-gradient-to-r from-primary to-electric text-primary-foreground px-6 py-2.5 rounded-xl text-sm font-semibold active:scale-95 transition-transform glow-primary" onClick={() => navigate(BUSINESS_BASE_PATH)}>
            Back to Gallery
          </button>
        </div>
        <BottomNav />
